...
DEPARTMENT_PRODUCTS = {
    ...
    "Boys Department": {
    "boys t-shirt": {
        "EN": "Boys t-shirt", "BG": "Момчешка тениска", "BiH": "T-shirt za dječake. Sastav materijala na ušivenoj etiketi.", "CZ": "Chlapecké tričko",
        "DE": "T-Shirt für Jungen", "EE": "Poiste T-särk",  "ES": "Camiseta de niño / samarreta nen",  "GR": "T-shirt για αγόρια",
        "HR": "T-shirt za dječake", "HU": "Fiú póló", "IT": "Maglietta per ragazzi", "LT": "Marškinėliai berniukui",
        "LV": "T-krekls zēniem", "PL": "T-shirt chłopięcy",  "PT": "T-shirt para rapaz", "RO": "T-shirt băieți",  "RS": "Majica za dečake. Sastav materijala nalazi se na ušivenoj etiketi",
        "SI": "Fantovska majica, kratki rokav",  "SK": "Chlapčenské tričko"
    },
    "boys pajamas": {
        "EN": "Boys pajamas", "BG": "Пижама за момчета", "BiH": "Pidžama za dječake. Sastav materijala na ušivenoj etiketi.", "CZ": "Chlapecké pyžamo",
        "DE": "Schlafanzug für Jungen","EE": "Poiste pidžaama",  "ES": "Pijama de niño / Pijama nen",  "GR": "Πιτζάμα για αγόρια",  "HR": "Pidžama za dječake",
        "HU": "Fiú pizsama",
